...
interface ColumnType {
    label: string;
    field?: string; // optional for normal fields
    fields?: FieldLabelPair[];   // optional for nested fields
                        ...
                        <Box key={col.field || col.label} sx={{ marginBottom: 3 }}>
                            ...
                            {col.type === "date" && col.field ? (
                                <Typography variant="body1" sx={{ color: "#1f2937" }}>
                                    {formatDate(selectedRow[col.field])}
                                </Typography>
                            ...
                            ) : col.field && Array.isArray(selectedRow[col.field]) ? (
                                <Box
                                    component="ul"
                                    sx={{
                                        color: "#1f2937",
                                ...
                                >
                                    {selectedRow[col.field].map((item: string, index: number) => (
                                        <li key={index}>
                                ...
                                <Typography variant="body1" sx={{ color: "#1f2937" }}>
                                    {col.field ? formatValue(selectedRow[col.field]) : "N/A"}
                                </Typography>
                            )}
                        </Box>
