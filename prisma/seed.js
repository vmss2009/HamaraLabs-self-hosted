...
function main() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          countryEntries = Object.values(countries_list_1.countries).map(
            function (country) {
              return {
        ...
        case 4:
          e_1 = _b.sent();
          if (e_1.code === "P2002") return [3 /*break*/, 5];           console.error(
            "Failed to insert country: ".concat(entry.country_name),
            e_1,
          );
          return [3 /*break*/, 5];
        case 5:
        ...
        case 8:
          ...
          indianStates = allStates.filter(function (state) {
            return state.country_code === INDIA_ISO2;
          });
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                ...
                case 2:
                  ...
                  return [
                    ...
                    prisma.city.createMany({
                      data: matchingCities.map(function (city) {
                        return {
                          city_name: city.name,
                ...
                case 3:
                  ...
                  console.log(
                    "\u2705 Added "
                      .concat(matchingCities.length, " cities for ")
                      .concat(state.name),
                  );
                  _c.label = 4;
                case 4:
