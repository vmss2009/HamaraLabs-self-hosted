...
export default function SchoolVisitReport() {
  ...
  const [selectedRow, setSelectedRow] = useState<SchoolVisitWithRelations | null>(null);
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      width: 150,
      renderCell: (params) => new Date(params.row.visit_date).toLocaleDateString(),
    },
    {
      ...
      renderCell: (params: { row: SchoolVisitWithRelations }) => (
        <div className="flex items-center justify-center gap-2 w-full h-full">
          <GridActionsCellItem
            icon={<EditIcon />}
            label="Edit"
            onClick={() => router.push(`/protected/school-visits/form/${params.row.id}`)}
          />
          <GridActionsCellItem
          ...
          {selectedRow ? (
            <Box>
              ...
              <Box sx={{ marginBottom: 3 }}>
                ...
                <Typography variant="body1" sx={{ color: "#1f2937" }}>
                  {formatValue(new Date(selectedRow.visit_date).toLocaleDateString())}
                </Typography>
              </Box>
              ...
              <Box sx={{ marginBottom: 3 }}>
                ...
                <Typography variant="body1" sx={{ color: "#1f2937" }}>
                  {formatValue((selectedRow.details as Record<string, any>)?.["No of UCs submitted"])}
                </Typography>
              </Box>
              ...
              <Box sx={{ marginBottom: 3 }}>
                ...
                <Typography variant="body1" sx={{ color: "#1f2937" }}>
                  {formatValue((selectedRow.details as Record<string, any>)?.["Planned showcase date"])}
                </Typography>
              </Box>
